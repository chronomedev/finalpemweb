...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Kualitas VVIP</h2>
				<p>Ruangan yang kulitas teratas dengan tingkat kenyamanan yang sempurna dengan tambahan firtur Khusus</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/vvip.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2> Kualitas VIP</h2>
				<p>Ruangan yang kulitas atas dengan tingkat kenyamanan yang sempurna </p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				...
				<div class="span9">
					...
					<div id="footer-menu-links">
						...
						<ul id="footer-nav">
							...
							<!--<li><a href="#">percobaan extreme</a></li> -->
