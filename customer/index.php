...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Kualitas VVIP</h2>
				<p>Ruangan yang kualitas teratas dengan tingkat kenyamanan yang sempurna dengan tambahan firtur Khusus</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="../img/parallax-slider/vvip.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2> Kualitas VIP</h2>
				<p>Ruangan yang kualitas atas dengan tingkat kenyamanan yang sempurna </p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="../img/parallax-slider/vip.png" alt="image03" /></div>
				
			</div>
			<div class="da-slide">
				<h2>Kualitas Menengah</h2>
				<p>Kami memproduksi jacket dan sweater, yang dapat di custom sesuai keinginan.</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="../img/parallax-slider/medium.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>Kualitas Bawah</h2>
				...
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="../img/parallax-slider/budget.png" alt="image04" /></div>
			</div>
			<nav class="da-arrows">
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
        		<p>
				Booking Cerdas merupakan website online, yang menyediakan berbagai macam kebutuhan ruangan penginapan. dengan harga yang sudah terjamin murah Booking Cerdas pasti akan dapat bersaing dipasaran
                </p>
				...
				<div class="icons-box-vert-container">
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Kami memberikan kualitas yang sudah terjamin dari vendor terpercaya.
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Kualitas Baik</h3>
								<p>Kami memberikan kualitas yang terbaik dan menjamin kenyamanan anda</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								<h3>Memesan Dengan Gadget</h3>
								<p>Anda bisa memesan produk kami melalui gadget kesayangan anda praktis dan mudah.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
